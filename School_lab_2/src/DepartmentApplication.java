...
public class DepartmentApplication
{
    public static void main(String[] args) throws IOException
    {
        ...
        Person John = new StaffStudent("Mary Jones","472-7322",32,3.80, 399);
        Person Jane = new StaffStudent("Lee Johnson","472-6009",19,3.65,489+62);
        dept.addPerson(John);
        dept.addPerson(Jane);
